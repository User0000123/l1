...
inline void DrawTriangle(PARAMS *pThreadParams, HDC dc, gsl_vector_int *pTriangleVertices, byte r, byte g, byte b)
{
    ...
    if (pThreadParams->pV0->data[1] > pThreadParams->pV1->data[1]) gsl_vector_swap(pThreadParams->pV0, pThreadParams->pV1); //<!-- gsl_vactor_swap exists 
    if (pThreadParams->pV0->data[1] > pThreadParams->pV2->data[1]) gsl_vector_swap(pThreadParams->pV0, pThreadParams->pV2);
    if (pThreadParams->pV1->data[1] > pThreadParams->pV2->data[1]) gsl_vector_swap(pThreadParams->pV1, pThreadParams->pV2);
	...
	for (int i=0; i<total_height; i++) {
        ...
        int offset;
        if (pThreadParams->pA->data[0] > pThreadParams->pB->data[0]) gsl_vector_swap(pThreadParams->pA, pThreadParams->pB);
...
inline void DrawTriangleIl(PARAMS *pThreadParams, int index)
{
    ...
    if (pThreadParams->pV0->data[1] > pThreadParams->pV1->data[1]) {
      ...
      gsl_vector_swap(pThreadParams->pV0, pThreadParams->pV1); //<!-- sgsl_vactor_swap exist
...
void CALLBACK task(PTP_CALLBACK_INSTANCE Instance, PVOID params, PTP_WORK Work)
{
    ...
    {
				//PrepareTriangleFillData(param, i);
